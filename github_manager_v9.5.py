...
# -*- coding: utf-8 -*-
"""
GitHub/Gitee Manager v9.5 - 本地代码托管管理工具
Author: LZF
Version: 9.5.0
"""
...
class App:
    ...
    def _build_ui(self):
        ...
        self.status_lbl = ttk.Label(status_bar, text=f"v{APP_VERSION} | Author: {APP_AUTHOR} | 当前平台: {self.platform}",
                                    foreground=t["fg3"], font=("Segoe UI", 9))
    ...
    def _tab_update(self):
        ...
        ttk.Label(f, text="格式：https://github.com/用户名/仓库名.git", foreground=t["fg3"],
                  font=("Microsoft YaHei UI", self.font_size - 1)).grid(row=r, column=2, sticky=tk.W, padx=4)
    ...
    def _tab_issues(self):
        ...
        t = self._current_theme
        self.is_body = scrolledtext.ScrolledText(f, height=4, wrap=tk.WORD, font=("Microsoft YaHei UI", self.font_size),
                                                  bg=t["entry_bg"], fg=t["entry_fg"],
                                                  insertbackground=t["entry_fg"], highlightthickness=0, bd=1, relief="solid")
    ...
    def _tab_pulls(self):
        ...
        ttk.Label(f, text="内容：").grid(row=r, column=0, sticky=tk.NW, pady=4)
        t = self._current_theme
        self.pr_body = scrolledtext.ScrolledText(f, height=4, wrap=tk.WORD, font=("Microsoft YaHei UI", self.font_size),
                                                  bg=t["entry_bg"], fg=t["entry_fg"],
                                                  insertbackground=t["entry_fg"], highlightthickness=0, bd=1, relief="solid")
    ...
    def _new_profile(self):
        name = tk.simpledialog.askstring("新建配置", "请输入配置名称：")
        if name:
    ...
    def _tab_about(self):
        ...
        ttk.Label(info_frame, text="Python：", font=("Microsoft YaHei UI", 10, "bold"),
                  foreground=t["fg"]).grid(row=2, column=0, sticky=tk.W, pady=3)
        ttk.Label(info_frame, text=f"{sys.version.split()[0]}", font=("Microsoft YaHei UI", 10),
        ...
        for i, feat in enumerate(features):
            ttk.Label(f, text=feat, font=("Microsoft YaHei UI", 9),
